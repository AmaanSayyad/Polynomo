...
✅ **Requirement 10.2**: Error messages for bet failures ("Insufficient house balance. Please deposit more.")
...
- Toast helpers automatically format amounts to 4 decimal places for POL/BNB/SOL
