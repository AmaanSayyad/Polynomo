...
describe('DepositModal', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    (usePolynomoStore as unknown as jest.Mock).mockReturnValue(defaultStoreState);
  });
  ...
  describe('Quick Select Buttons', () => {
    ...
    it('should disable quick select buttons that exceed wallet balance', () => {
      (usePolynomoStore as unknown as jest.Mock).mockReturnValue({
        ...defaultStoreState,
        balance: '15.0',
      });
