...
export const WalletConnect: React.FC = () => {
  ...
  const { network, setNetwork, setIsConnected, setAddress, setPreferredNetwork } = usePolynomoStore();
        ...
        <div className="flex items-center gap-2">
          <div className="bg-white/5 border border-white/10 rounded-xl px-3 py-1.5 flex items-center gap-2.5">
            <div className="w-4 h-4 shrink-0">
              <img
                src={solanaConnected ? '/logos/solana-sol-logo.png' : network === 'POLYGON' ? 'https://cryptologos.cc/logos/polygon-matic-logo.png' : '/logos/bnb-bnb-logo.png'}
                alt="Network"
            ...
            <div className="flex flex-col items-end">
              <span className="text-[8px] text-gray-500 font-bold uppercase tracking-tighter">
                {solanaConnected ? 'Solana Network' : network === 'POLYGON' ? 'Polygon' : 'BNB Smart Chain'}
              </span>
