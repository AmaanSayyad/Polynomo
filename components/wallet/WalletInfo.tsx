...
export const WalletInfo: React.FC = () => {
  const { network, address, isConnected, walletBalance, refreshWalletBalance } = usePolynomoStore();
  ...
  const networkName = network === 'SOL' ? 'Solana' : network === 'POLYGON' ? 'Polygon' : 'Binance';
