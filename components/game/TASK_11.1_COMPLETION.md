...
- **Improved error messages**: Shows specific message about depositing more POL/BNB/SOL when house balance is insufficient
...
- Error message: "Insufficient house balance. You have X.XX POL (or BNB/SOL). Please deposit more."
...
5. API deducts balance and records bet (server-side)
