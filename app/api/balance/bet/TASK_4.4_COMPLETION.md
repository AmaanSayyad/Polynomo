...
```typescript
{
  userAddress: string;      // Wallet address (EVM or Solana)
  betAmount: number;        // Amount to bet (POL/BNB/SOL)
...
3. **Contract Integration:**
   - Prepares transaction to call `placeBetFromHouseBalance` on PolynomoGame contract
...
1. **Insufficient Balance:**
   - Returns: "Insufficient house balance. Please deposit more."
   - Status: 400
