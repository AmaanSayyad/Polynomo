...
- Validates EVM address format (0x...) or Solana address where applicable

**Response Format:**
```typescript
{
  balance: number,      // Current house balance (POL/BNB/SOL)
...
1. **Address Validation**
   - Validates address format (EVM 0x... or Solana base58)
